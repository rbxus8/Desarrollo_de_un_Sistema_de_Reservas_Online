...
function Reservas() {
  ...
  function handleSubmit(e) {
    ...
    setMensajeConfirmacion(
      `Gracias, ${formData.nombre}. Tu reserva para la ${tiposHabitacion.find(
        (t) => t.value === formData.tipoHabitacion
      ).label} desde ${formData.fechaEntrada} hasta ${formData.fechaSalida} ha sido recibida. Nos contactaremos pronto.`
    );
  ...
  return (
    <main className="min-h-screen bg-gray-50 px-6 py-20 max-w-3xl mx-auto">
      ...
      >
        {/* Nombre */}
        <div>
          <label htmlFor="nombre" className="block mb-1 font-semibold text-gray-700">
        ...
        {/* Teléfono */}
        <div>
          <label htmlFor="telefono" className="block mb-1 font-semibold text-gray-700">
            Teléfono
          </label>
          <input
            type="tel"
